...
@Composable
fun StarijaGrupaScreen(navController: NavController) {
    ...
    when (val state = dataState.value) {
        is DataState.Success -> {
            ...
            var memberList by remember { mutableStateOf(state.data.filter { it.type == MemberType.STARIJA_GRUPA }.toMutableList()) }
